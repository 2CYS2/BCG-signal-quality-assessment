...
class_names = ['1', '2', '3']
print("每个类别的精确率和召回率：\n", classification_report(target_test, predict_results, target_names=class_names))
